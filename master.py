...
"background-color: rgb(244, 244, 244);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Мастер"))
        self.client_2.setPlaceholderText(_translate("MainWindow", "Статус проблемы"))
        self.opisanie_2.setPlaceholderText(_translate("MainWindow", "Замена"))
        self.model_2.setPlaceholderText(_translate("MainWindow", "Дата окончания"))
